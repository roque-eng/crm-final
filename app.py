...
USUARIOS = {"RDF": "Rockuda.4428", "AV": "Ale2025", "JOE": "Joe2025", "ANDRE": "Andre2025", "AB": "ABentancor2025", "GR": "GRobaina2025", "ER": "ERobaina.2025", "GS": "GSanchez2025", "MDF": "Matiti2025", "EH": "EHugo2025", "AP": "APerdomo2025", "RS": "RSierra2025", "LT": "LTomasi2025", "EC": "ECabral2025", "PG": "PGagliardi2025"}
...
if 'logueado' not in st.session_state or not st.session_state['logueado']:
    ...
    st.markdown("""
        <div style="display:flex; justify-content:left; padding: 20px 20px 20px 450px;">
...
with tab_car:
    ...
    if not df_c.empty:
        ...
        if filas_seleccionadas and filas_seleccionadas[0] < len(df_c):
            ...
            with st.container(border=True):
                ...
                with cx1:
                    ...
                    st.write(f"• **Documento:** {fila_completa.get('Documento de Identidad (Rut/Cédula/Otros)', 'N/D')}")
                    st.write(f"• **Celular:** {fila_completa.get('Celular', 'N/D')}")
                    st.write(f"• **Mail:** {fila_completa.get('Dirección de correo electrónico', 'N/D')}")
                with cx2:
            ...
            if nombre_cliente and col_aseg_raw in df_raw.columns:
                mask = (df_raw[col_aseg_raw] == nombre_cliente)
                if ramo_cliente and col_ramo_raw in df_raw.columns:
                    mask = mask & (df_raw[col_ramo_raw] == ramo_cliente)
                if matricula_cliente and col_mat_raw in df_raw.columns:
                    mask = mask & (df_raw[col_mat_raw] == matricula_cliente)
